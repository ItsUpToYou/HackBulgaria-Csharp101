...
namespace PandaNetwork
{
    class Program
    {
        ...
        {
            Panda panda1 = new Panda(name: "Peter", email: "peter@hackbg.com", gender:GenderType.Male);
            Panda panda2 = new Panda(name: "Maria", email: "maria@hackbg.com", gender: GenderType.Female);
            Panda panda3 = new Panda(name: "Jim", email: "jim@hackbg.com", gender: GenderType.Male);
            Panda panda4 = new Panda(name: "Jennifer", email: "jennifer@yahoo.com", gender: GenderType.Female);
            Panda panda5 = new Panda(name: "Joe", email: "joe@google.com", gender: GenderType.Male);
            Panda panda6 = new Panda(name: "Tim", email: "Tim@google.com", gender: GenderType.Male);
            Panda panda7 = new Panda(name: "Bob", email: "bob@hackbg.com", gender: GenderType.Male);
            Panda panda8 = new Panda(name: "Victoria", email: "victoria@google.com", gender: GenderType.Female);
            Panda panda9 = new Panda(name: "Julie", email: "julie@hackbg.com", gender: GenderType.Female);
